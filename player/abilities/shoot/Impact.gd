...
func _ready():
	...
	$ColorTween.interpolate_property(material, "emission", Color(1, 1, 1), Color(0.85, 0.6, 0.1), 0.1, Tween.TRANS_SINE, Tween.EASE_IN_OUT)
	$ColorTween.interpolate_property(material, "emission", Color(0.85, 0.6, 0.1), Color(0, 0, 0), 0.1, Tween.TRANS_SINE, Tween.EASE_IN_OUT, 0.1)
