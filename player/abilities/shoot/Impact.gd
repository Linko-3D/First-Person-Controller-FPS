...
func _ready():
	...
	$ColorTween.interpolate_property(material, "emission", Color(1, 1, 1), Color(1, 0.8, 0.2), 0.1, Tween.TRANS_SINE, Tween.EASE_IN_OUT)
	$ColorTween.interpolate_property(material, "emission", Color(1, 0.8, 0.2), Color(0, 0, 0), 0.1, Tween.TRANS_SINE, Tween.EASE_IN_OUT, 0.1)
