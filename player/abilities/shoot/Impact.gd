...
func _ready():
	...
	$ColorTween.interpolate_property($OmniLight, "light_energy", 0.1, 0, 0.1, Tween.TRANS_SINE, Tween.EASE_IN_OUT)
	$ColorTween.interpolate_property($OmniLight, "light_indirect_energy", 0.1, 0, 0.1, Tween.TRANS_SINE, Tween.EASE_IN_OUT)
